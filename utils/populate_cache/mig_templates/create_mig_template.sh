...
gcloud compute instance-templates create-with-container ${TEMPLATE_NAME} \
    ...
    --create-disk=^,@^description=Stores\ just\ the\ word-lapse\ models,\ without\ version\ control\ metadata.,@device-name=word-lapse-models,@image=projects/word-lapse/global/images/word-lapse-models-02-24-2022,@mode=rw,@size=32,@type=pd-ssd \
